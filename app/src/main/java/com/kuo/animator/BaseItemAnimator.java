...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public ArrayList<ViewHolder> mRemoveAnimations = new ArrayList<ViewHolder>();
    ...
    private void animateRemoveImpl(final ViewHolder holder){
        setAnimateRemove(holder);
        mRemoveAnimations.add(holder);
    }

    protected abstract void prepareAnimateRemove(ViewHolder holder);

    protected abstract void setAnimateRemove(final ViewHolder holder);
    ...
    private void animateAddImpl(final ViewHolder holder) {
        setAnimateAdd(holder);
        mAddAnimations.add(holder);
    }

    protected abstract void prepareAnimateAdd(final ViewHolder holder);

    protected abstract void setAnimateAdd(final ViewHolder holder);
    ...
    protected abstract class AddListenerAdapter implements ViewPropertyAnimatorListener {

        RecyclerView.ViewHolder viewHolder;

        public AddListenerAdapter(final RecyclerView.ViewHolder holder) {
            viewHolder = holder;
        }
    ...
    protected abstract class RemoveListenerAdapter implements ViewPropertyAnimatorListener {

        RecyclerView.ViewHolder viewHolder;

        public RemoveListenerAdapter(final RecyclerView.ViewHolder viewHolder) {
